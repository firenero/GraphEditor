...
namespace GraphEditor.Graphics
{
    public abstract class GraphicsBase : DrawingVisual
    {
        ...
        // external rectangle
        static SolidColorBrush ext_track_brush = new SolidColorBrush(Color.FromArgb(255, 65, 177, 225));
        // internal
        static SolidColorBrush int_track_brush = new SolidColorBrush(Color.FromArgb(255, 255, 255, 255));
        ...
        public Color CurrentColor
        {
            get
            {
                return IsSelected ? graphicsSelectedColor : graphicsObjectColor;
            }
        }
