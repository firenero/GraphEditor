    ...
    abstract class ToolObject : Tool
    {
        ...
        public override void OnMouseUp(GraphCanvas drawingCanvas, MouseButtonEventArgs e)
        {
            if (drawingCanvas.Count > 0)
            {
                ...
                drawingCanvas.AddCommandToHistory(new CommandAdd(drawingCanvas[drawingCanvas.Count - 1], drawingCanvas.GraphStructure.GetElement(drawingCanvas[drawingCanvas.Count - 1].Id)));
            }
